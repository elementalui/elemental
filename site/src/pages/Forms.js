	...
	render () {
		...
		return (
			<div className="demo-container container">
				...
				<h2>Basic Example</h2>
				<p>Individual form controls automatically receive some global styling. All textual <code className="inline-code">{`<FormInput>`}</code>, and <code className="inline-code">{`<FormSelect>`}</code> elements with are set to width: 100%; by default. Wrap controls in <code className="inline-code">{`<FormField>`}</code> for optimum spacing.</p>
